...
- Para configurar las cuentas de correo de cada usuario, accede a **Cuentas de Email**.
  ...
  >**Importante** La configuracion del servidor de entrada/salida y los puertos tienen que estar bien definida segun el proveedor que usais. De esa manera se podra mandar y recibir correos desde informes o desde notificacion segun como tengas configurado.
