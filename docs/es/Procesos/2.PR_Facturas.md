...
- **1-** Para generar enviar la factura desde ENBLAU, es necesario que en **Empresa** o **General** tengan completados ciertos campos obligatorios. Como Cif, Código de país, Usuario (Verifactu) y ApiKey (Verifactu). 
    ...
    - Desde el apartado, Configuración - **Empresa**.
        ...
        ![Facturae empresa](Imagenes/PR_Facturas/verifactu_general.png)
...
> ℹ️ **Nota**: Los datos de Usuario (Verifactu) y ApiKey (Verifactu) serán proporcionados por Endades.
