...
**10. Transformación (Puesto 9)**
  ...
  - Descuenta el listado de materiales definido en cada escandallo. Además, si en el escandallo, desde ENBLAU, se ha indicado una referencia de material en el campo de **Producto terminado**, se generará una entrada en stock con dicha referencia de artículo. Para más información, sigue este enlace: [2.1. Creación de Escandallos](/Utilidades/9.UT_Escandallos/)
