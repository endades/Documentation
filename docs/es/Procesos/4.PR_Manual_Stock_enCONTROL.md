...
> ℹ️ **Nota:** Para información más detallada sobre recepción de materiales en ENBLAU, sigue este enlace: [4.2. Recepción de material](1.PR_Ventas_Compras.md#42-recepcion-de-material)
...
**9. Persiana (Puesto 8)**
  ...
  - Se descuenta materiales (persianas) por cuadro.
    ...
    ![persiana](Imagenes/PR_Stock_Control/puesto_persiana.jpg)

**10. Transformación (Puesto 9)**

  - Ese puesto puedes indicar un grupo de materiales (enMATERIALS) definidas en escandallo para transformar en un producto, ejemplo: Barandilla. 

    ![transformacion](Imagenes/PR_Stock_Control/transformacion.jpg)

  - Descuenta el listado de materiales definido en cada escandallo. Además, si en el escandallo, desde ENBLAU, se ha indicado una referencia de material en el campo de **Producto terminado**, se generará una entrada en stock con dicha referencia de artículo en la ubicación indicada. Para más información, sigue este enlace: [2.1. Creación de Escandallos](/Utilidades/9.UT_Escandallos/)
