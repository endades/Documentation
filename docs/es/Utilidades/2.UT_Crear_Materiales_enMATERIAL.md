...
Desde la pestaña **Tipo de sistema**, en la parte inferior, se mostrará una ventana donde se puede seleccionar el tipo de sistema:
...
Desde la pestaña **Opciones**, en la parte inferior, se mostrará una ventana con las opciones relacionadas con el tipo de sistema.
