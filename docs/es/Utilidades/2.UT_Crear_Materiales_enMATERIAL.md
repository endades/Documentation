...
En la ***ventana central*** se muestra el diseño de la fachada ventilada correspondiente al tipo de sistema seleccionado.
  ...
  - **Pestaña Mecanizado cuelgue**  
    Permite importar el dibujo en formato `.dwg/.dxf`.
  - **Pestaña Otros mecanizados**  
...
Rellenar los campos de información general según el tipo de cálculo seleccionado:
   ...
   ![Artículo enCLAD](Imagenes/UT_Crear_Material/enclad_articulo1.png)
...
![Artículo enCLAD](Imagenes/UT_Crear_Material/enclad_articulo4.1.png)

   - **Pieza separadora**

![Artículo enCLAD](Imagenes/UT_Crear_Material/enclad_articulo4.png)
...
Marcar el tipo de rol del perfil (solo para artículos de tipo **barra**) y definir su valor en el apartado de fachada ventilada.
   ...
   ![Artículo enCLAD](Imagenes/UT_Crear_Material/enclad_articulo7.png)
...
![Artículo enCLAD](Imagenes/UT_Crear_Material/enclad_articulo2.png)
...
![Artículo enCLAD](Imagenes/UT_Crear_Material/enclad_articulo3.png)

**6. Comercial y stock (asignar colores)**

Cada color y material tendrá una referencia única _(Referencia Artículo + Referencia Color)_. Arrastra uno o más colores desde la pestaña de colores en la ventana derecha, de la pestaña **Comercial y stock**.

   ![Asignar Color](Imagenes/UT_Crear_Material/asignar_color.png)

> ℹ️ **Nota:** Información sobre como crear nuevos colores ir a [3.2. Creación de colores](#32-creación-de-colores).
...
![Reglas enCLAD](Imagenes/UT_Crear_Material/enclad_reglas2.png)
...
![Reglas enCLAD](Imagenes/UT_Crear_Material/enclad_reglas3.png)
...
![Reglas enCLAD](Imagenes/UT_Crear_Material/enclad_reglas4.png)
...
![Reglas enCLAD](Imagenes/UT_Crear_Material/enclad_reglas5.png)
