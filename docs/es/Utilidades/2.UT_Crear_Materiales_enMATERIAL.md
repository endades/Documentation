...
- Desde la pestaña inferior **General** rellenar los campos para la propiedad del material dependiendo del tipo de cálculo seleccionado, **barra**, **pieza**, **junta** o **superficie**.
...
- Desde la pestaña inferior **Datos técnicos** importar dwg/dxf del material y definir las dimensiones del dibujo, como:
...
- Desde la pestaña **Reglas** arrastra una regla desde la ventana lateral derecha inferior de la pestaña **Reglas** previamente definida.
