...
## 13. Sistemas de fachada ventilada en enCLAD

Hay 4 sistemas de fachada ventilada disponibles en enCLAD:

### 13.1. Sistema de cuelgue

El **sistema de cuelgue** es un sistema de anclaje mecánico oculto.
    
  ![enCLAD](Imagenes/UT_enCLAD/enclad_sistema1.png)
    
  ![enCLAD](Imagenes/UT_enCLAD/enclad_sistema1.1.png)

### 13.2. Sistema macho-hembra

El **sistema macho-hembra** es un sistema de ensamble por encaje.
...
El **sistema pegado** es un sistema de adhesivo estructural.
    
  ![enCLAD](Imagenes/UT_enCLAD/enclad_sistema4.png)
    
  ![enCLAD](Imagenes/UT_enCLAD/enclad_sistema4.1.png)

### 13.4. Sistema remachado

El **sistema remachado** es un sistema de fijación mecánica vista.
...
## 14. Creación de materiales enMATERIALS

Desde el módulo enMATERIALS se creará los materiales de cada sistema de fachadas ventiladas.

Para más información, sigue este enlace: [Creación de sistemas y materiales enCLAD](/Utilidades/2.UT_Crear_Materiales_enMATERIAL/#9-creacion-de-sistemas-y-materiales-enclad)
