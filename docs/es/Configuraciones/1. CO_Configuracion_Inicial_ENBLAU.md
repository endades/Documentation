# Configuración inicial de [ENBLAU](https://endades.com/software/software-enblau/)
...
- **Ruta de almacenamiento**: Indicar la ruta donde se guardarán los documentos de ENBLAU y Logikal (unidad de red). Ejemplo:
  ...
  > ℹ️ **Nota:** Es recomendable utilizar una unidad de red. Si no existe, créala.
...
> ℹ️ **Nota:** Para correos de Microsoft Exchange se recomiendan que en **Modo de envío de emails** en el apartado de General que esté la opción **Modo de envío 2** seleccionada.
...
> ℹ️ **Nota:** Los directorios predeterminados son carpetas que pueden configurarse para que se generen automáticamente con cada proyecto.
...
> ℹ️ **Nota:** La numeración de los documentos nunca se debe acabar en "0".
...
> ℹ️ **Nota:** Los directorios predeterminados son carpetas que pueden configurarse para que se generen automáticamente con cada documentación.
