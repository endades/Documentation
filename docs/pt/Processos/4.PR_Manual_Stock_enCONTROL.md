...
**10. Transformação (Posto 9)**
  ...
  - Desconta a lista de materiais definida em cada ficha técnica. Além disso, se na ficha técnica, a partir do ENBLAU, tiver sido indicada uma referência de material no campo **Produto acabado**, será gerada uma entrada em stock com essa referência de artigo. Para mais informações, consulta o seguinte link: [2.1. Criação de Escandallos](/Utilidades/9.UT_Escandallos/)
