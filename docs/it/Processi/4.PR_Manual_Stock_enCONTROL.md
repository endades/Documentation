...
## 2. Taglio
  ...
  - In Taglio si indica la lunghezza della barra e gli scarti. Si apre una finestra degli scarti e la lunghezza può essere modificata secondo necessità.

    ![taglio](Imagenes/PR_Stock_Control/corte.jpg)

    ![scarti](Imagenes/PR_Stock_Control/desperdicio.jpg)

    > **Nota:** Da ENBLAU, vai in Configurazione - Generale - **Logikal**. È possibile indicare lo **Scarto minimo** da considerare quando si taglia una barra nella postazione **Taglio**.

      ![scarti](Imagenes/PR_Stock_Control/retales.jpg)

      ![scarti](Imagenes/PR_Stock_Control/retales2.jpg)

  - Poi, da ENBLAU **Movimenti di magazzino**, verrà registrata l'uscita totale della barra (es. 6500) e poi l'entrata dello stesso materiale (es. 4100) come indicato nella postazione di taglio.

    ![movimenti barra](Imagenes/PR_Stock_Control/movimientos_barra.jpg)

    - Inoltre, in ENBLAU, nella sezione **Stock**, è possibile visualizzare l'elenco filtrato per **È scarto** di tutti gli scarti disponibili in magazzino.

      ![scarti](Imagenes/PR_Stock_Control/retales3.jpg)

  - Nella sezione **Tagliati** della postazione di taglio di enCONTROL, sul lato destro del monitor, viene mostrato l'elenco dei tagli effettuati e si possono stampare le etichette di ogni barra.

    ![tagliati](Imagenes/PR_Stock_Control/cortados.jpg)
