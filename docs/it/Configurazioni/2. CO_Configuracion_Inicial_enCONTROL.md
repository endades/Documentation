# Configurazione iniziale di [enCONTROL](https://endades.com/software/encontrol/)
...
- Si definisce la modalità con cui verranno scaricati dallo stock i profili, i ferramenta e gli accessori man mano che avanza la produzione.
  ...
  - **Scaricare dalla zona, in mancanza dal progetto**: La sottrazione viene effettuata dalla zona indicata e dal progetto. La posizione della zona per i materiali da utilizzare viene definita dalla postazione **Preparazione dei materiali**. Perché la sottrazione sia corretta, il materiale deve trovarsi nella zona indicata ed essere assegnato al progetto.

  - **Scaricare dalla zona**: La sottrazione viene effettuata solo dalla zona indicata, indipendentemente dal progetto. La posizione della zona per i materiali da utilizzare viene definita dalla postazione **Preparazione dei materiali**. Perché la sottrazione sia corretta, il materiale deve trovarsi nella zona indicata.
