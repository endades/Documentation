...
Nella modalità di lavoro puoi definire come ENBLAU agirà con Logikal durante la creazione di nuove versioni, l’accettazione dei preventivi, la generazione di una misurazione o la creazione di una produzione in ENBLAU.

- Configuralo dalla sezione Configurazione - Generale - **Logikal**.

  ![Version](Imagenes/UT_ENBLAU_LOGIKAL/modo_logikal1.png)

  ![Version](Imagenes/UT_ENBLAU_LOGIKAL/modo_logikal.png)
