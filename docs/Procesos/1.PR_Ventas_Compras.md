...
> **Nota:** Para crear documentos de venta y compra, es importante tener creados **proyectos, clientes y proveedores**. Para más información, sigue este enlace: [4. Proyecto, cliente y proveedores](4.PR_Proyecto_cliente.md).
...
- Los materiales adicionales se pueden añadir al pedido, medición o producción. Son materiales propios creados desde enMATERIAL. Para más información sobre cómo crear materiales propios, sigue este enlace: [2. Creación de materiales propios en enMATERIALES](/docs/Utilidades/2.UT_Crear_Materiales_enMATERIAL.md).
...
- El material se añadirá en el apartado de **Roturas**. En la columna *Concepto*, puedes indicar el motivo de la rotura, seleccionando de una lista predefinida en la configuración de Conceptos de rotura ([1. Configuración Inicial de ENBLAU](/docs/Configuraciones/1.%20CO_Configuracion_Inicial_ENBLAU.md)).
...
> **Gestion de Filtros** Usar filtros y filtros personalizados para optimizar la busqueda en los listados. Para más información sobre cómo crear materiales propios, sigue este enlace: [4. Gestión de Filtros](/docs/Utilidades/4.UT_Gestion_Filtros.md)
