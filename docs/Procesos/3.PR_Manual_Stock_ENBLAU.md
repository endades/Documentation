...
> **Importante!** Si no hay el material en stock, no se descontará.

> **Nota:** Para tener un controle más detallado de stock se recomienda usar la app móvil enSITE para hacer ese tipo de descuento de material. Para más información sobre la app [enSITE](4.PR_Manual_Stock_enCONTROL.md#4-compras)
