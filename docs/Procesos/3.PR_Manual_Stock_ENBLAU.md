...
- **Stock mínimo**, **stock máximo** y **stock habitual**:  
  Puedes definir los valores de referencia para la gestión de existencias, lo cual es útil para alertas, reposiciones o planificación.
    ...
    En el apartado de [Reposición de stock](#24-reposición-de-stock) en compras se puede sacar un listado de Bajo mínimo y Bajo habitual según como este definido el stock mínimo, máximo y habitual para cada material.
