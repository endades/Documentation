...
- En el apartado de **Almacenes** tienes una opción **Pendiente de recibir** donde te muestra un listado donde se puede visualizar los materiales pendiente de recibir para cada proyecto y pedido de compra.
...
> **Nota:** Para información más detallada sobre pedido de compras, sigue este enlace: [Pedidos de Compras](1.PR_Ventas_Compras.md#4-compras)
...
> **Nota:** Para más información sobre como definir para cada material el stock mínimo, stock máximo y stock habitual ir al apartado [Configuración de materiales](#51-configuracion-de-materiales).
...
- En el apartado de **Almacenes** - **Inventarios** se puede una normalización en el almacén teniendo en cuenta lo que hay en stock en tiempo real.
...
### 4.2. Contabilización de Stock
  ...
  1. Desde un inventario elegir el **Proyecto** que tienes definido como **Stock**.
  2. Clicar sobre **Obtener stock** para cargar una lista de los materiales en el proyecto **Stock**:

    ![Inventarios](Imagenes/PR_Stock_Control/inventarios3.jpg)

    ![Inventarios](Imagenes/PR_Stock_Control/inventarios4.jpg)

  3. En la columna **Unidades contabilizadas** insertar las unidades reales en stock del artículo indicado según haya contabilizado en la ubicación del almacén. 

    ![Inventarios](Imagenes/PR_Stock_Control/inventarios5.jpg)

  4. Una vez indicado las unidades en Unidades contabilizadas, las líneas de los artículos se pondrán en roja indicando que ha habido un cambio de unidades. Luego clicar sobre **Actualizar almacén** para estabilizar en almacén según las unidades contabilizadas.

    ![Inventarios](Imagenes/PR_Stock_Control/inventarios6.jpg)
  
  5. Al actualizar almacén las líneas de los artículos se pondrán en verde, indicando en la columna **Unidades Stock** y **Unidades contabilizadas** que se ha actualizado correctamente las unidades en stock. Además, te indicará en la columna **Contabilizado** una casilla marcada y en la columna **Fecha contabilizada** la fecha que se actualizó esa regularización de stock.

    ![Inventarios](Imagenes/PR_Stock_Control/inventarios7.jpg)

  7. También se puede añadir nuevos artículos desde los apartados de Artículos (materiales ENBLAU) y Artículos importados (materiales listados de Logikal). Añadirlos arrastrar el artículo al listado del inventario, indicar las unidades, dimensiones (en caso de que sea de tipo barra, superficie o juntas), ubicación en stock y precio.
...
> **Nota:** La correcta configuración de estos campos mejora significativamente el control de inventario, la planificación de compras y la trazabilidad de materiales durante la producción. En el apartado 
