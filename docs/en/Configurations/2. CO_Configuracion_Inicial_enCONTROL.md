# Initial Configuration of [enCONTROL](https://endades.com/en/software-eng/software-encontrol/) 
...
- The mode in which profiles, fittings, and accessories are deducted from stock as production progresses is defined here.
  ...
  - **Deduct from the zone, or from the project if not available:** The deduction is made from the specified zone and the project. The location of the zone for the materials to be used is defined from the **Materials Preparation** workstation. For the deduction to be applied correctly, the material must be in the indicated zone and assigned to the project.

  - **Deduct from the zone:** The deduction is made only from the specified zone, regardless of the project. The location of the zone for the materials to be used is defined from the **Materials Preparation** workstation. For the deduction to be applied correctly, the material must be in the indicated zone.
